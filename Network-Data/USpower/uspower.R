...
# Reading data into R and making it a undirected graph
uspower_uu <-  read.table("http://opsahl.co.uk/tnet/datasets/USpowergrid_n4941.txt"
...
#' @param name A string
#' @return A pdf with a plot of USpower
plot_uspower <- function(net, nodes=NULL, file_path,file_name,name){
