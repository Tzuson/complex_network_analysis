...
The files in this map contain the data to generate networks with the igraph package. Each map contains four maps: 
...
There are also three files with R-code in each map (here ):
